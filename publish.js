...
function addSignatureReturns(f) {
	...
	/*
	 f.signature = '<span class="signature">' + (f.signature || '') + '</span>' +
		...
		'</span>';
	*/
	f.signature = view.partial('signature.tmpl',{signature: f.signature, returnTypes: returnTypes});
}
...
function buildNav(members) {
	...
	nav = view.partial('nav.tmpl',{members: members, linkto: linkto, ifUnseen: ifUnseen});
	return nav;
}
